...
def _make_proxy_modules():
    ...
    cosyvoice_modules = [
        ...
        'cosyvoice.hifigan',
        'cosyvoice.dataset',  # 用于配置文件解析（推理时不需要，但hyperpyyaml需要）
        'cosyvoice.dataset.processor',  # 用于配置文件解析（推理时不需要，但hyperpyyaml需要）
    ]
...
# 再导入需要的对象与子模块
# 注意：必须先导入 cli 子包，因为 cosyvoice.py 依赖 frontend.py
from .cosyvoice import cli as _cv_cli
from .cosyvoice.cli import frontend as _cv_frontend
from .cosyvoice.cli import cosyvoice as _cv_cosyvoice
from .cosyvoice.utils.file_utils import load_wav

from .cosyvoice import llm as _cv_llm, flow as _cv_flow, transformer as _cv_transformer, utils as _cv_utils, hifigan as _cv_hifigan, dataset as _cv_dataset
...
from .cosyvoice.utils import common as _cv_utils_common, mask as _cv_utils_mask, file_utils as _cv_utils_file_utils, frontend_utils as _cv_utils_frontend_utils, class_utils as _cv_utils_class_utils
from .cosyvoice.hifigan import generator as _cv_hifigan_generator
from .cosyvoice.dataset import processor as _cv_dataset_processor
...
# 绑定所有子模块名到 sys.modules
sys.modules['cosyvoice.cli'] = _cv_cli
sys.modules['cosyvoice.cli.frontend'] = _cv_frontend
sys.modules['cosyvoice.cli.cosyvoice'] = _cv_cosyvoice
...
sys.modules['cosyvoice.utils.mask'] = _cv_utils_mask
sys.modules['cosyvoice.utils.file_utils'] = _cv_utils_file_utils
sys.modules['cosyvoice.utils.frontend_utils'] = _cv_utils_frontend_utils
sys.modules['cosyvoice.utils.class_utils'] = _cv_utils_class_utils
sys.modules['cosyvoice.hifigan'] = _cv_hifigan
sys.modules['cosyvoice.hifigan.generator'] = _cv_hifigan_generator
sys.modules['cosyvoice.dataset'] = _cv_dataset
sys.modules['cosyvoice.dataset.processor'] = _cv_dataset_processor
...
# 导入CosyVoice类
from .cosyvoice.cli.cosyvoice import CosyVoice2, CosyVoice3, AutoModel


# 导入TTS服务类
from .tts_service import TTSService, AsyncTTSService
